...
0 бит - Неверная контрольная сумма NVR  
1 бит - Неверная контрольная сумма в конфигурации  
2 бит - Зарезервировано  
3 бит - Зарезервировано  
4 бит - Зарезервировано  
5 бит - ККТ не авторизовано  
6 бит - Фатальная ошибка ФН  
...
0 бит - Не была вызвана функция “Начало работы”  
1 бит - Нефискальный режим  
2 бит - Смена открыта  
3 бит - Смена больше 24 часов  
4 бит - Архив ФН закрыт  
5 бит - ФН не зарегистрирован  
6 бит - Зарезервировано  
7 бит - Зарезервировано  
8 бит - Не было завершено закрытие смены, необходимо повторить операцию  

**Статус документа**  
0..4 бит - Тип текущего открытого документа  
   * 0 - документ закрыт  
